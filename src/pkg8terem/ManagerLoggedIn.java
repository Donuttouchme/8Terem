 ...
 * @author tobak
 */
public class ManagerLoggedIn extends javax.swing.JFrame {

    /**
     * Creates new form ManagerLoggedIn
     */
    public ManagerLoggedIn() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Menü hozzáadása");
        ...
        jButton3.setText("Rendelések kezelése");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerLoggedIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerLoggedIn().setVisible(true);
            }
        });
    }
